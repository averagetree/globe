...
`},Ce={name:"data-filter",vs:Ae,fs:Fe,inject:Le,getUniforms:Oe},Ie={name:"data-filter-fp64",vs:Ae,fs:Fe,inject:Le,getUniforms:Gt};var Re=_(ke(),1);var Ut=`#version 300 es
...
`;var Ge=`const vec2 E_FP64 = vec2(2.7182817459106445e+00, 8.254840366817007e-08);
...
`;var{fp64ify:Vr,fp64ifyMatrix4:jr}=J,re={name:"project64",dependencies:[te.project,J],vs:Qe,getUniforms:Gr},zr=(0,te._memoize)(Ur);function Gr(r){if(r&&"viewport"in r){let{viewProjectionMatrix:e,scale:t}=r.viewport;return zr({viewProjectionMatrix:e,scale:t})}return{}}function Ur({viewProjectionMatrix:r,scale:e}){let t=jr(r),o=Vr(e);return{project_uViewProjectionMatrixFP64:t,project64_uViewProjectionMatrix:t,project64_uScale:o}}var oe=class extends S.LayerExtension{getShaders(){let{coordinateSystem:e}=this.props;if(e!==S.COORDINATE_SYSTEM.LNGLAT&&e!==S.COORDINATE_SYSTEM.DEFAULT)throw new Error("fp64: coordinateSystem must be LNGLAT");return{modules:[re]}}};oe.extensionName="Fp64Extension";var Je=oe;var k=_(d(),1);var et={inject:{"vs:#decl":`
...
`}};var qr={getDashArray:{type:"accessor",value:[0,0]},getOffset:{type:"accessor",value:0},dashJustified:!1,dashGapPickable:!1},R=class extends k.LayerExtension{constructor({dash:e=!1,offset:t=!1,highPrecisionDash:o=!1}={}){super({dash:e||o,offset:t,highPrecisionDash:o})}isEnabled(e){return"pathTesselator"in e.state}getShaders(e){if(!e.isEnabled(this))return null;let t={};return e.opts.dash&&(t=(0,k._mergeShaders)(t,et)),e.opts.offset&&(t=(0,k._mergeShaders)(t,tt)),t}initializeState(e,t){let o=this.getAttributeManager();!o||!t.isEnabled(this)||(t.opts.dash&&o.addInstanced({instanceDashArrays:{size:2,accessor:"getDashArray"},instanceDashOffsets:t.opts.highPrecisionDash?{size:1,accessor:"getPath",transform:t.getDashOffsets.bind(this)}:{size:1,update:i=>{i.constant=!0,i.value=[0]}}}),t.opts.offset&&o.addInstanced({instanceOffsets:{size:1,accessor:"getOffset"}}))}updateState(e,t){if(!t.isEnabled(this))return;let o={};t.opts.dash&&(o.dashAlignMode=this.props.dashJustified?1:0,o.dashGapPickable=Boolean(this.props.dashGapPickable)),this.state.model?.setUniforms(o)}getDashOffsets(e){let t=[0],o=this.props.positionFormat==="XY"?2:3,i=Array.isArray(e[0]),s=i?e.length:e.length/o,n,a;for(let l=0;l<s-1;l++)n=i?e[l]:e.slice(l*o,l*o+o),n=this.projectPosition(n),l>0&&(t[l]=t[l-1]+I.dist(a,n)),a=n;return t[s-1]=0,t}};R.defaultProps=qr;R.extensionName="PathStyleExtension";var rt=R;var it=_(d(),1);var N=_(d(),1);var Hr=`
...
`},Jr={name:"clip-fs",fs:at},eo={"vs:#decl":`
