...
const RuxGlobalStatusBar = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("header", { part: "container" }, index.h("slot", { name: "left-side" }, this.includeIcon && (index.h("rux-icon", { icon: `${this.menuIcon}`, size: "small", class: this.appState || this.username
      ...
      this.appName ||
      this.appVersion) && (index.h(AppMeta, { domain: this.appDomain, name: this.appName, version: this.appVersion }, index.h("div", { class: "app-state-wrapper" }, this.appState && (index.h("div", { class: `app-state ${this.appStateColor}`, part: "app-state" }, this.appState)), this.username && (index.h("div", { class: "username", part: "username" }, this.username)))))), index.h("div", { class: "slotted-content", part: "middle" }, index.h("slot", null)), index.h("slot", { name: "right-side" }))));
  }
};
