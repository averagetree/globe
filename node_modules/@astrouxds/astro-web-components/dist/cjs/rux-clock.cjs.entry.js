...
const index$2 = require('./index-21b709f7.js');
...
function getDayOfYear(dirtyDate) {
  ...
  var diff = index.differenceInCalendarDays(date, startOfYear(date));
...
const RuxClock = class {
  ...
  _formatTime(time, timezone) {
    return index$2.format(index$2.utcToZonedTime(time, timezone), `HH:mm:ss ${this.hideTimezone ? '' : this.tzFormat}`, { timeZone: timezone });
  }
  _handleDateIn() {
  ...
  _updateTime() {
    if (this.dateIn) {
      if (!this.hasRun) {
        ...
        const clockDate = index$2.utcToZonedTime(this._rawTime, this._timezone);
      ...
      const clockDate = index$2.utcToZonedTime(localDate, this._timezone);
      this.dayOfYear = getDayOfYear(clockDate);
    }
  }
  /**
  ...
  _formatLosAosDateIn(dateTime) {
    ...
    return index$2.format(index$2.utcToZonedTime(dateTime, this._timezone), 'HH:mm:ss');
  }
  ...
  render() {
    return (index$1.h(index$1.Host, null, index$1.h("div", { class: "rux-clock", part: "container" }, !this.hideDate && (index$1.h("div", { class: "rux-clock__segment" }, index$1.h("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__day-of-year-label", part: "date" }, this.dayOfYear.toString().padStart(3, '0')), !this.hideLabels && (index$1.h("div", { class: "rux-clock__segment__label", id: "rux-clock__day-of-year-label", part: "date-label" }, "Date")))), index$1.h("div", { class: "rux-clock__segment" }, index$1.h("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__time-label", part: "time" }, this.time), !this.hideLabels && (index$1.h("div", { class: "rux-clock__segment__label", id: "rux-clock__time-label", part: "time-label" }, "Time"))), this.aos && (index$1.h("div", { class: "rux-clock__segment rux-clock__aos" }, index$1.h("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__time-label--aos", id: "rux-clock__time--aos", part: "aos" }, this.convertedAos), !this.hideLabels && (index$1.h("div", { class: "rux-clock__segment__label", id: "rux-clock__time-label--aos", part: "aos-label" }, "AOS")))), this.los && (index$1.h("div", { class: "rux-clock__segment rux-clock__los" }, index$1.h("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__time-label--los", id: "rux-clock__time--los", part: "los" }, this.convertedLos), !this.hideLabels && (index$1.h("div", { class: "rux-clock__segment__label", id: "rux-clock__time-label--los", part: "los-label" }, "LOS")))))));
  }
