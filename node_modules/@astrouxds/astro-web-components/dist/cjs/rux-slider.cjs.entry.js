...
const RuxSlider = class {
  ...
  render() {
    ...
    utils.renderHiddenInput(true, el, name, JSON.stringify(value), disabled);
    if (minVal !== undefined) {
      utils.renderHiddenSliderInput(true, el, name ? `${name}-min-val` : '', JSON.stringify(minVal), disabled);
    }
    return (index.h(index.Host, null, index.h("div", { class: "rux-form-field", part: "form-field" }, hasLabel ? (index.h("label", { class: {
        ...
        hidden: !hasLabel,
      }, "aria-hidden": hasLabel ? 'false' : 'true', htmlFor: sliderId, part: "label" }, index.h("slot", { name: "label" }, label))) : null, index.h("div", { class: {
        'rux-slider': true,
        'rux-slider--range': minVal !== undefined ? true : false,
      }, onClick: _handleTrackClick }, minVal !== undefined ? (index.h("input", { type: "range", class: "rux-range rux-range--dual", onInput: _onMinValInput, onChange: _onChange, disabled: disabled, min: min, max: max, step: step, value: minVal, onBlur: _onBlur })) : null, index.h("input", { id: sliderId, onInput: _onInput, onChange: _onChange, type: "range", class: {
        'rux-range': true,
        'rux-range--dual': minVal !== undefined ? true : false,
      }, min: min, max: max, step: step, value: value, disabled: disabled, "aria-label": "slider", "aria-disabled": disabled ? 'true' : 'false', onBlur: _onBlur, part: "input" }), minVal !== undefined ? (index.h("div", { class: "rux-range-overlay" })) : null), axisLabels.length > 0 ? (index.h("datalist", { id: "steplist", style: {
        gridTemplateColumns: `[tick] repeat(${axisLabels.length - 1}, ${this._getTickWidths()}%)`,
      } }, axisLabels.map((label) => {
      return (index.h("div", { class: "tick-label", part: "tick-container" }, index.h("div", { class: "tick", part: "tick" }), ticksOnly ? null : (index.h("div", { class: "axis-label", part: "axis-label" }, label))));
