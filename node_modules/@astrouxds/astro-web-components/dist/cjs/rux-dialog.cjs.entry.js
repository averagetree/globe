...
const RuxDialog = class {
  ...
  render() {
    ...
    return (open && (index.h(index.Host, null, index.h("div", { part: "container", class: "rux-dialog__wrapper" }, index.h("dialog", { class: "rux-dialog__dialog", role: "dialog", part: "dialog" }, index.h("header", { class: {
      ...
      }, part: "footer" }, this.hasFooter ? (index.h("slot", { name: "footer", onSlotchange: this._handleSlotChange })) : (index.h(index.Fragment, null, index.h("div", { class: "rux-button-group" }, index.h("rux-button", { secondary: confirmText.length > 0, onClick: _handleDialogChoice, "data-value": "false", hidden: !denyText, tabindex: "0", exportparts: "container:deny-button", id: "rux-dialog-deny-button" }, denyText), index.h("rux-button", { onClick: _handleDialogChoice, hidden: !confirmText, "data-value": "true", tabindex: "1", exportparts: "container:confirm-button" }, confirmText)), index.h("slot", { name: "footer", onSlotchange: this._handleSlotChange })))))))));
  }
