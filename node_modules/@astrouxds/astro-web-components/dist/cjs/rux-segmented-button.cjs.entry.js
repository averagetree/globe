...
const RuxSegmentedButton = class {
  ...
  render() {
    return (index.h("ul", { class: {
      ...
      } }, this.data.map((item) => (index.h("li", { class: "rux-segmented-button__segment" }, index.h("input", { type: "radio", name: this.segBtnName, id: this._slugify(item.label), value: item.label, checked: this._isSelected(item.label), "data-label": item.label, onChange: this._handleChange, disabled: this.disabled, onFocus: this._handleFocus, onBlur: this._handleBlur }), index.h("label", { htmlFor: this._slugify(item.label), part: "label", class: {
