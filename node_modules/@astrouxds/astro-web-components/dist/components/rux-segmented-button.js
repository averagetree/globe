...
let name = 0;
const RuxSegmentedButton$1 = /*@__PURE__*/ proxyCustomElement(class RuxSegmentedButton extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    return (h("ul", { class: {
      ...
      } }, this.data.map((item) => (h("li", { class: "rux-segmented-button__segment" }, h("input", { type: "radio", name: this.segBtnName, id: this._slugify(item.label), value: item.label, checked: this._isSelected(item.label), "data-label": item.label, onChange: this._handleChange, disabled: this.disabled, onFocus: this._handleFocus, onBlur: this._handleBlur }), h("label", { htmlFor: this._slugify(item.label), part: "label", class: {
