...
const RuxDialog$1 = /*@__PURE__*/ proxyCustomElement(class RuxDialog extends HTMLElement {
  ...
  render() {
    ...
    return (open && (h(Host, null, h("div", { part: "container", class: "rux-dialog__wrapper" }, h("dialog", { class: "rux-dialog__dialog", role: "dialog", part: "dialog" }, h("header", { class: {
      ...
      }, part: "footer" }, this.hasFooter ? (h("slot", { name: "footer", onSlotchange: this._handleSlotChange })) : (h(Fragment, null, h("div", { class: "rux-button-group" }, h("rux-button", { secondary: confirmText.length > 0, onClick: _handleDialogChoice, "data-value": "false", hidden: !denyText, tabindex: "0", exportparts: "container:deny-button", id: "rux-dialog-deny-button" }, denyText), h("rux-button", { onClick: _handleDialogChoice, hidden: !confirmText, "data-value": "true", tabindex: "1", exportparts: "container:confirm-button" }, confirmText)), h("slot", { name: "footer", onSlotchange: this._handleSlotChange })))))))));
  }
...
function defineCustomElement$1() {
  ...
  const components = ["rux-dialog", "rux-button", "rux-icon"];
