...
const RuxTab$1 = /*@__PURE__*/ proxyCustomElement(class RuxTab extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    return (h(Host, { onClick: this._clickHandler, selected: this.selected }, h("div", { part: "container", class: {
        'rux-tab': true,
        'rux-tab--selected': this.selected,
        'rux-tab--small': this.small,
        'rux-tab--large': !this.small,
        'rux-tab--disabled': this.disabled,
      }, role: "tab", tabindex: this.disabled || !this.selected ? '-1' : '0' }, h("slot", null), h("slot", { name: "actions" }))));
  }
  get el() { return this; }
