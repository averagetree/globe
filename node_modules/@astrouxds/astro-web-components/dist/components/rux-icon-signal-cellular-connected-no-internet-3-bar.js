...
const RuxIconSignalCellularConnectedNoInternet3Bar$1 = /*@__PURE__*/ proxyCustomElement(class RuxIconSignalCellularConnectedNoInternet3Bar extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.size = 'auto';
