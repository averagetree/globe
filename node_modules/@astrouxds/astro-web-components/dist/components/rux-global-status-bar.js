...
const RuxGlobalStatusBar$1 = /*@__PURE__*/ proxyCustomElement(class RuxGlobalStatusBar extends HTMLElement {
  ...
  render() {
    return (h(Host, null, h("header", { part: "container" }, h("slot", { name: "left-side" }, this.includeIcon && (h("rux-icon", { icon: `${this.menuIcon}`, size: "small", class: this.appState || this.username
      ...
      this.appName ||
      this.appVersion) && (h(AppMeta, { domain: this.appDomain, name: this.appName, version: this.appVersion }, h("div", { class: "app-state-wrapper" }, this.appState && (h("div", { class: `app-state ${this.appStateColor}`, part: "app-state" }, this.appState)), this.username && (h("div", { class: "username", part: "username" }, this.username)))))), h("div", { class: "slotted-content", part: "middle" }, h("slot", null)), h("slot", { name: "right-side" }))));
  }
