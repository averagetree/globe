...
const RuxIconSignalCellularConnectedNoInternet2Bar$1 = /*@__PURE__*/ proxyCustomElement(class RuxIconSignalCellularConnectedNoInternet2Bar extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.size = 'auto';
