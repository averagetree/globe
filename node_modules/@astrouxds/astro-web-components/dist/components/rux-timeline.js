...
import { a as addMilliseconds, t as toInteger, d as dateRange, g as getStartEndDateForInterval, b as differenceInMinutes, c as differenceInHours, e as getBeginningOfMonth, f as differenceInMonths, h as daysInMonth, v as validateTimezone } from './helpers.js';
import { r as requiredArgs, t as toDate, g as getTimezoneOffsetInMilliseconds } from './index3.js';
...
const RuxTimeline$1 = /*@__PURE__*/ proxyCustomElement(class RuxTimeline extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return ruxTimelineCss; }
    ...
    "zoom": [514],
    "playhead": [1537],
    "hasPlayedIndicator": [516, "has-played-indicator"],
    "interval": [1],
    "timezone": [1],
