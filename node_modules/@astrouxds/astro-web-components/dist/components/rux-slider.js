...
import { h as hasSlot, r as renderHiddenInput, c as renderHiddenSliderInput } from './utils.js';
...
let id = 0;
const RuxSlider$1 = /*@__PURE__*/ proxyCustomElement(class RuxSlider extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
