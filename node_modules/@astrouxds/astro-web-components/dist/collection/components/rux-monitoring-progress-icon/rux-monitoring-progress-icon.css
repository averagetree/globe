...
svg.rux-status--off {
  stroke: var(--status-symbol-color-fill-off-on-dark, #9ea7ad);
  fill: var(--status-symbol-color-fill-off-on-dark, #9ea7ad);
}

svg.rux-status--standby {
  stroke: var(--status-symbol-color-fill-standby-on-dark, #2dccff);
  fill: var(--status-symbol-color-fill-standby-on-dark, #2dccff);
}

svg.rux-status--normal {
  stroke: var(--status-symbol-color-fill-normal-on-dark, #56f000);
  fill: var(--status-symbol-color-fill-normal-on-dark, #56f000);
}

svg.rux-status--caution {
  stroke: var(--status-symbol-color-fill-caution-on-dark, #fce83a);
  fill: var(--status-symbol-color-fill-caution-on-dark, #fce83a);
}

svg.rux-status--serious {
  stroke: var(--status-symbol-color-fill-serious-on-dark, #ffb300);
  fill: var(--status-symbol-color-fill-serious-on-dark, #ffb300);
}

svg.rux-status--critical {
  stroke: var(--status-symbol-color-fill-critical-on-dark, #ff3838);
  fill: var(--status-symbol-color-fill-critical-on-dark, #ff3838);
}
