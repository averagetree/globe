...
:host input:focus-visible + .rux-push-button__button {
...
:host .rux-push-button__button {
  ...
  align-items: center;
  color: var(--color-text-interactive-default, #4dacff);
  border-radius: var(--radius-base, 3px);
  box-shadow: var(--color-border-interactive-default, #4dacff) 0 0 0 1px inset;
  padding: var(--spacing-2, 0.5rem) var(--spacing-4, 1rem);
}
:host .rux-push-button__button:hover {
  cursor: pointer;
  color: var(--color-background-interactive-hover, #92cbff);
  box-shadow: var(--color-background-interactive-hover, #92cbff) 0 0 0 1px inset;
}
...
:host .rux-push-button__button--small.rux-push-button__button--icon-only {
  padding: var(--spacing-1, 0.25rem);
}
:host .rux-push-button__button--large {
  padding: var(--spacing-3, 0.75rem) var(--spacing-4, 1rem);
}
:host .rux-push-button__button--large.rux-push-button__button--icon-only {
...
:host .rux-push-button__input:checked + .rux-push-button__button {
  ...
  background-color: var(--color-palette-green-500, #56f000);
  box-shadow: var(--color-palette-green-500, #56f000) 0 0 0 1px inset;
}
...
:host .rux-push-button__input:checked + .rux-push-button__button:hover {
  background-color: var(--color-palette-green-400, #99f666);
}
