import { addHours, differenceInHours, differenceInMinutes, addDays, addMinutes, subMinutes, differenceInMonths, differenceInDays, } from 'date-fns';
...
export function getBeginningOfMonth(date, amount) {
...
export function getBeginningOfDay(date, amount) {
...
export function daysInMonth(theDate) {
  return new Date(theDate.getFullYear(), theDate.getMonth() + 1, 0).getDate();
}
export function getStartEndDateForInterval(startDate, endDate, interval) {
