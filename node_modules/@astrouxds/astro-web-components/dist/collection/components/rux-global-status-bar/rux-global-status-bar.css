:host {
  ...
  width: -moz-available;
  width: stretch;
  padding: 0 calc(var(--spacing-6, 1.5rem) - var(--spacing-1, 0.25rem));
  box-sizing: border-box;
  background-color: var(--gsb-color-background, #172635);
...
header::-webkit-scrollbar-thumb:active, header::-webkit-scrollbar-thumb:hover {
...
::slotted(rux-icon[slot=left-side]) {
  height: calc(var(--spacing-8, 2rem) + var(--spacing-050, 0.125rem));
  font-size: var(--spacing-8, 2rem);
}
...
::slotted(rux-monitoring-icon[slot=right-side]) {
  display: flex;
  align-items: center;
  padding-right: calc(var(--spacing-4, 1rem) + var(--spacing-2, 0.5rem));
...
::slotted(*[slot=app-meta]) {
  ...
  margin: var(--spacing-0, 0rem) auto var(--spacing-0, 0rem) var(--spacing-0, 0rem);
...
.app-meta h1 {
  ...
  font-family: var(--font-heading-1-font-family, 'Roboto', -apple-system, BlinkMacSystemFont, 'Segoe UI', Oxygen-Sans, Ubuntu, Cantarell, 'Helvetica Neue', sans-serif);
  font-size: var(--font-heading-1-font-size, 2.125rem);
  font-weight: var(--font-heading-1-font-weight, 400);
  letter-spacing: var(--font-heading-1-letter-spacing, 0.0025em);
  line-height: var(--font-heading-1-line-height, calc(40 / 34));
}

.app-meta h1.app-domain {
  margin-right: var(--spacing-2, 0.5rem);
  font-family: var(--font-heading-1-bold-font-family, 'Roboto', -apple-system, BlinkMacSystemFont, 'Segoe UI', Oxygen-Sans, Ubuntu, Cantarell, 'Helvetica Neue', sans-serif);
  font-size: var(--font-heading-1-bold-font-size, 2.125rem);
  font-weight: var(--font-heading-1-bold-font-weight, 700);
  letter-spacing: var(--font-heading-1-bold-letter-spacing, 0.0025em);
  line-height: var(--font-heading-1-line-height, calc(40 / 34));
}
...
.app-version {
  ...
  font-family: var(--font-heading-6-font-family, 'Roboto', -apple-system, BlinkMacSystemFont, 'Segoe UI', Oxygen-Sans, Ubuntu, Cantarell, 'Helvetica Neue', sans-serif);
  font-size: var(--font-heading-6-font-size, 1.125rem);
  font-weight: var(--font-heading-6-font-weight, 300);
  letter-spacing: var(--font-heading-6-letter-spacing, 0em);
  line-height: var(--font-heading-6-line-height, calc(24 / 18));
}
...
.app-state {
  box-sizing: border-box;
  color: var(--color-palette-neutral-000, #ffffff);
  background-color: var(--color-palette-neutral-1000, #000000);
  ...
  padding: calc(var(--spacing-050, 0.125rem) + var(--spacing-025, 0.0625rem)) var(--spacing-2, 0.5rem);
  text-align: center;
  margin-right: var(--spacing-2, 0.5rem);
  white-space: nowrap;
}
...
.username {
  ...
  letter-spacing: var(--font-body-2-letter-spacing, 0.005em);
  line-height: var(--line-height-xs, 1rem);
  padding: calc(var(--spacing-050, 0.125rem) + var(--spacing-025, 0.0625rem)) var(--spacing-0, 0rem);
  height: calc(var(--spacing-6, 1.5rem) - var(--spacing-050, 0.125rem));
}
...
::slotted(*) {
  ...
  --color-background-surface-selected: #1c3f5e;
  ...
  --color-border-focus-default: #da9ce7;
  ...
  --color-data-visualization-1: #00c7cb;
  --color-data-visualization-2: #938bdb;
  --color-data-visualization-3: #4dacff;
  --color-data-visualization-4: #70dde0;
  --color-data-visualization-5: #c9c5ed;
  --color-data-visualization-6: #92cbff;
  --color-data-visualization-7: #a1e9eb;
  --color-data-visualization-8: #b7dcff;
  --border-width-focus-default: 1px;
  --spacing-focus-default: 0.125rem;
  --shadow-overlay: 0px 4px 4px 1px rgba(0, 0, 0, 0.45);
}

.app-state.tag1 {
  background: var(--color-palette-teal-600, #009fa3);
}

.app-state.tag2 {
  background: var(--color-palette-purple-600, #6058a8);
}

.app-state.tag3 {
  background: var(--color-palette-pink-600, #81009a);
}

.app-state.tag4 {
  background: var(--color-palette-hotorange-600, #af420a);
}