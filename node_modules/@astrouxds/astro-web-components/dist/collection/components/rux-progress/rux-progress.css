...
.rux-progress[value] {
  ...
  border: 1px solid var(--color-background-surface-default, #1b2d3e);
  border-radius: var(--progress-radius-outer, 10px);
  box-shadow: 0 0 0 1px var(--color-background-interactive-default, #4dacff);
  height: calc(var(--spacing-4, 1rem) + var(--spacing-050, 0.125rem));
  width: 100%;
...
.rux-progress[value]::-webkit-progress-value {
  border-radius: 0 var(--spacing-4, 1rem) var(--spacing-4, 1rem) 0;
