...
.rux-menu-item:hover {
  color: var(--color-text-interactive-hover, #92cbff);
  background: var(--color-background-base-hover, #142435);
}
.rux-menu-item:focus-visible {
...
.rux-menu-item--selected {
  background: var(--color-background-base-selected, #1c3f5e);
