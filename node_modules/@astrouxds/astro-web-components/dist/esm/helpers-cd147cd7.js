...
import { r as requiredArgs, t as toDate, d as differenceInCalendarDays } from './index-13979ffd.js';
...
function getBeginningOfMonth(date, amount) {
...
function getBeginningOfDay(date, amount) {
...
function getStartEndDateForInterval(startDate, endDate, interval) {
  let timelineStart = new Date(startDate);
  let timelineEnd = new Date(endDate);
  if (interval === 'month') {
    timelineEnd = new Date(getBeginningOfMonth(timelineEnd, 1).getTime() - 1);
...
function dateRange(start, end, interval, intervalValue = 1, timezone = 'UTC') {
  ...
  if (interval === 'month') {
    ...
    const output = [...Array(numIntervals).keys()].map((i) => {
      ...
      const formattedTime = i === 0 || time.getMonth() === 0
  ...
  if (interval === 'week') {
    ...
    const output = [...Array(days).keys()].map((i) => {
      ...
      const formattedTime = i === 0 || showYear
        ? formatInTimeZone(time, timezone, 'MM/dd/yy')
        : formatInTimeZone(time, timezone, 'MM/dd');
      return [formattedTime];
    });
...
export { addMilliseconds as a, differenceInMinutes as b, differenceInHours as c, dateRange as d, getBeginningOfMonth as e, differenceInMonths as f, getStartEndDateForInterval as g, daysInMonth as h, differenceInMilliseconds as i, differenceInDays as j, getBeginningOfDay as k, toInteger as t, validateTimezone as v };
